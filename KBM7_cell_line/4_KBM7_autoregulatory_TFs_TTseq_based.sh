########################################################
# Identification of autoregulatory TFs
########################################################

cd ${KBM7_working_dir}/bed/Rose_SE_hg38_p9_noOverlap_H3K4me3_TSS/CRC_inhouse

SE_bed=${KBM7_working_dir}/bed/Rose_SE_hg38_p9_noOverlap_H3K4me3_TSS/KBM7_H3K27ac_hg38_peaks_Gateway_SuperEnhancers.bed

subpeaks=${KBM7_working_dir}/bed/KBM7_H3K27ac_hg38_peaks.noOverlap_H3K4me3_TSS.bed

TADs_bed=${KBM7_working_dir}/KBM7_Rao_2014-raw_TADs.2.hg38.bed

expressed_genes_bed=expressed_genes_only_NM.bed


awk -F "\t" '{print $0 "\t" $1":"$2"-"$3}' ../KBM7_H3K27ac_hg38_peaks_Gateway_SuperEnhancers.bed > SEs_faIDs.bed
...
cbust_on_SEs_directory=${KBM7_working_dir}/bed/Rose_SE_hg38_p9_noOverlap_H3K4me3_TSS/CRC_inhouse/cbust_output_SE_IDs/

TFs_list=${KBM7_working_dir}/bed/Rose_SE_hg38_p9_noOverlap_H3K4me3_TSS/CRC_inhouse/expressed_TFs_list.assigned_to_SEs.txt
...
file_with_closest_genes=${KBM7_working_dir}/bed/Rose_SE_hg38_p9_noOverlap_H3K4me3_TSS/CRC_inhouse/genesets/geneset_2b.txt
